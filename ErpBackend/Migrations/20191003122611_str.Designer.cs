...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErpBackend.Models.PayRoll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("NationalInsurance");
            ...
            modelBuilder.Entity("ErpBackend.Models.Employee", b =>
                {
                    b.HasOne("ErpBackend.Models.Department", "Department")
                        .WithMany("Employees")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ErpBackend.Models.Designation", "Designation")
                        .WithMany("Employees")
